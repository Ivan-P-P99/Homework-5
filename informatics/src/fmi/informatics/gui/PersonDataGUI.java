...
public class PersonDataGUI {
	...
	public void createAndShowGUI() {
		...
		JButton buttonSortAscending = new JButton("Asending");
		JButton buttonSortDescending = new JButton("Descending");
		...
		// Добавяме диалог
		final JDialog sortDialog = new CustomDialog(getSortText(), this, null);
